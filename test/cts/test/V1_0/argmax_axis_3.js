describe('CTS', function() {
    ...
    const nn = navigator.ml_polyfill.getNeuralNetworkContext();
    options = {
        backend : 'WebGL',
        prefer : 'sustained'
    };
    it('check result for ARGMAX with 4D axis 3 example/1', async function() {
    ...
    it('check result for ARGMAX with 4D axis 3 example/2', async function() {
      let model = await nn.createModel(options);
      let operandIndex = 0;
